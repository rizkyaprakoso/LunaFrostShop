                ...
                <div class="card-body">
                    <?php if ($transaksi) { ?>
                        <form method="post" enctype="multipart/form-data" action="">
                            ...
                            <h5 class="text-center mb-3" style="font-weight: 300">Silahkan Transfer ke Rekening Berikut</h5>
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="file" class="form-control-file" id="bukti_transfer" name="bukti_transfer" required>
                            </div>
